...
import cardsCss from '../Ressources/assets/css/cards.css';
import handsCss from '../Ressources/assets/css/hands.css';
import tableCss from '../Ressources/assets/css/table.css';
import chipsCss from '../Ressources/assets/css/chips.css';
...
export const CardStyles = () => (
    <style style={cardsCss} />
);
export const HandStyles = () => (
    <style style={handsCss} />
);
export const ChipStyles = () => (
    <style style={chipsCss} />
);
export const TableStyles = () => (
    <style style={tableCss} />
);
 ...
 * Deck
 ******************************************************************/
export const Deck = ({ cards=[], size=52, className, style, onClickStyle, onClick=()=>{}, onHover=()=>{}  }) => {
        ...
        <ul className={ reducedClassNames(defaultClasses, className) } style={newStyle}>
            {
                styles.map((style,i) => {
                    return (
                        <li key={i} style={style} onClick={() => setStyle(i,onClickStyle, styles)}>
...
export const Card = ({ suit, face, className, style, onClick=()=>{}, onHover=()=>{} }) => {
    ...
    return (
      ...
      <img src={ require(`../Ressources/assets/png/cards/${face}${suit}.png`) } alt={`${face}${suit}`} style={{width: 150, height: 217, ...style}} />
    </span>
    );
};
/******************************************************************
...
export const Chip = ({ color, value, width, height, className, style, onClick=()=>{}, onHover=()=>{} }) => {
    ...
    return (
      ...
      <img src={ require(`../Ressources/assets/png/chips/${color}.png`) } alt={`${color}`} style={imgStyle} />
    </span>
    );
};
/******************************************************************
...
export const Table = ({ children, background, noStyle }) => {
    ...
    return (
        <div className="table-background" style={{backgroundImage: `url(${require(`../Ressources/assets/png/textures/${texture}.png`)})`}}>
            {
                noStyle ? null : (
                    <div>
                        <CardStyles />
